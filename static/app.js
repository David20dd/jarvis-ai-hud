(() => {
  ...
  const state = {
    ...
    apiBase: normalizeBase(localStorage.getItem(STORE.apiBase) || ''),
    lastPrompt: '',
    wakeRetrying: false
  };
  ...
  function appendAssistant(text, meta = {}, scroll = true, animateBlocks = true) {
    ...
    avatar.src = '/static/jarvis-reactor.svg';
    avatar.alt = 'JARVIS';
  ...
  async function renderSystem() {
    ...
    els.sheetBody.innerHTML = `
      ...
      <div class="panel-card">
        ...
        <p>Deja este campo vacío cuando la interfaz y el backend están publicados juntos en Render.</p>
